...
export const NODE_COMMAND_EVENT = "node-command";
export const NODE_ALERT_EVENT = "node-alert";
export const NODE_MAINTENANCE_REQUEST_EVENT = "node-maintenance-request";
