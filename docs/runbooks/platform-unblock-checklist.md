...
3. **Alert webhook fire-drill on Render** — `ALERT_WEBHOOK_*` + `backend/scripts/alert-webhook-fire-drill.ts`
...
7. **Pen-test (#47)** — sign `docs/pentest/authorization-and-scope.md`, pick vendor
8. **POPIA (#48)** — Information Officer signs policy + first row in `docs/policies/access-review-log.md`
