...
| Release CI evidence for RC | CI P0 | **Done 2026-08-12 → RC-2026-08-12** | Engineering | `d0cfd3f` required jobs green on PR #102 + signed release | https://github.com/technetechtt-dotcom/GridFlexAi/actions/runs/31589974341 · release https://github.com/technetechtt-dotcom/GridFlexAi/actions/runs/31590302889 | Engineering / 2026-08-12 |
| Signed RC image + SBOM | Supply P0 | **RC-2026-08-12 Done 2026-08-12** | Engineering | Cosign + OIDC for `rc-2026-08-12` @ `d0cfd3f` | digest `sha256:644f623f…378c` · release https://github.com/technetechtt-dotcom/GridFlexAi/actions/runs/31590302889 · manifest `74a29301…a5fa` | Engineering / 2026-08-12 |
...
| Credential rotation / issue #45 | Provider P0 | **Partial** | Security + ops / before staging | Bootstrap script secured 2026-08-12 (no shell, dual-confirm keys); IAM/CMK still missing; restore local vault rehearsal only | SHA-256 `a6314a3ebfacf1c1d9d3014692d0a04f13e791dd418079b5e06c84b14d8eab9e` | |
...
| Observability fire drill / issue #50 | Ops P0 | **Partial** | Ops / before staging | Local webhook PASS; `verify:observability-readiness` fail-closed without Render secrets; **ALERT_WEBHOOK deliver/ack still Open** | SHA-256 `4440732a3e1413a0af3c9d77cfea2188759207b4ce0f2b93ae2a5be8785a11b8` | |
