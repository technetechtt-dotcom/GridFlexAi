...
| Release CI evidence for RC | CI P0 | **Done 2026-07-23 → RC-2026-07-23; RC-2026-08-12 pending freeze SHA** | Engineering | `cdcd3e7` required jobs green + manifest | https://github.com/technetechtt-dotcom/GridFlexAi/actions/runs/29988892052 · manifest `37cd37f0…6d72` | Engineering / 2026-07-23 |
| Signed RC image + SBOM | Supply P0 | **RC-2026-07-23 Done; RC-2026-08-12 pending tag/sign** | Engineering | Cosign + OIDC for `rc-2026-08-12` after freeze SHA | prior digest `sha256:accf07fc…c718` superseded for new deploys | |
