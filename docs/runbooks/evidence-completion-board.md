...
| Credential rotation / issue #45 | Provider P0 | **Partial** | Security + ops / before staging | Restore provision+rotate Done (local vault); staging/prod aws_kms **blocked** (no AWS CLI/keys on workstation as of 2026-08-03) | SHA-256 `a6314a3ebfacf1c1d9d3014692d0a04f13e791dd418079b5e06c84b14d8eab9e` | |
...
| Observability fire drill / issue #50 | Ops P0 | **Partial** | Ops / before staging | Live probes Done; catalog ownership + dashboard/drain stubs Done; local webhook dispatcher + negative paths PASS (`4440732a…a11b8`); env parity requires `ALERT_WEBHOOK_*` (PR #87); Render `ALERT_WEBHOOK_*` deliver/ack still Open | SHA-256 `4440732a3e1413a0af3c9d77cfea2188759207b4ce0f2b93ae2a5be8785a11b8` | |
| Staging/prod parity promotion | Release P0 | **Partial — key schema PASS; digest deploy Open** | Release manager / every promotion | Same `sha256:` digest on staging then prod; env-parity PASS 68 keys `a8f7e560…158b` | `parity-promotion-evidence.md` | |
| Load soak / issue #50 | Performance P1 | **Partial** | Engineering / before production | k6 live health PASS; signed restore ingest 5/5 PASS (1 VU); fan-out/reconnect PASS; Redis fail-closed **CI Done** (PR #84); staging multi-VU / Redis-under-traffic Open (no staging URL / Docker on workstation) | health `5e66d876…c1bd`; signed ingest `374276c33c964b395d8057e3fbc5d8cd49dee39c26c1b0c6e81074957b8a4405` | |
