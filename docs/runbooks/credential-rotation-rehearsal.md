...
- **Blocked on workstation 2026-08-03:** AWS CLI not installed; `AWS_ACCESS_KEY_ID` / `AWS_PROFILE` unset; `verify-kms-readiness` fail with 5 blockers. Follow [`aws-kms-setup.md`](./aws-kms-setup.md) once IAM + Render env exist.
